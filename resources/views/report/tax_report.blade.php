...
<section class="content">
    <div class="print_section">
        <h2>{{session()->get('business.name')}} - @lang( 'report.tax_report' )</h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            @slot('title')
            {{ __('Summary') }} @show_tooltip(__('Summary of Total Sales'))
            @endslot
            <h3 class="text-muted">
                {{ __('Total Sales') }}:
                <span class="t_sell">
