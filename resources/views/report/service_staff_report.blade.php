        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="ssr_location_id">{{ __('purchase.business_location') }}:</label>
                    <select name="ssr_location_id" id="ssr_location_id" class="form-control select2" style="width:100%">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="service_staff_id">{{ __('restaurant.service_staff') }}:</label>
                    <select name="service_staff_id" id="service_staff_id" class="form-control select2" style="width:100%" placeholder="{{ __('lang_v1.all') }}">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="ssr_date_range">{{ __('report.date_range') }}:</label>
                    <input type="text" name="date_range" id="ssr_date_range" class="form-control"
        ...
        service_staff_report = $('table#service_staff_report').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'transactions.total_before_tax'
                },
                {
