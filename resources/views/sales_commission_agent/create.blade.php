                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="first_name" id="first_name" class="form-control" required placeholder="@lang('business.first_name')">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control" placeholder="@lang('business.email')">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_no" id="contact_no" class="form-control" placeholder="@lang('lang_v1.contact_no')">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" class="form-control" rows="3" placeholder="@lang('business.address')"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="cmmsn_percent" id="cmmsn_percent" class="form-control" step="0.01" required placeholder="@lang('lang_v1.cmmsn_percent')">
                        </div>
                    </div>
