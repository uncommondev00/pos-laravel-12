...
<section class="content">
    ...
    <form action="{{ route('roles.update', $role->id) }}" method="POST" id="role_form">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" required
                        ...
                        value="{{ str_replace('#' . auth()->user()->business_id, '', $role->name) }}">
                </div>
            </div>
        </div>
                    ...
                    <div class="checkbox">
                        <label>
                            ...
                            <input type="checkbox" name="permissions[]"
                                ...
                                {{ in_array($section . '.' . $permission, $role_permissions) ? 'checked' : '' }}>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="permissions[]" value="{{ $permission }}"
                                class="input-icheck"
                                {{ in_array($permission, $role_permissions) ? 'checked' : '' }}>
                            {{ __($label) }}
                        </label>
        ...
        <!--Next-->
        @php
        $selected_permissions = $role_permissions ?? [];
        @endphp
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="permissions[]" value="{{ $report }}"
                                class="input-icheck"
                                {{ in_array($report, $selected_permissions) ? 'checked' : '' }}>
                            {{ __('role.' . $report) }}
                        </label>
                    </div>
                </div>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="permissions[]" value="{{ $setting }}"
                                class="input-icheck"
                                {{ in_array($setting, $selected_permissions) ? 'checked' : '' }}>
                            {{ __('role.' . $setting) }}
                        </label>
                    </div>
                </div>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="permissions[]" value="dashboard.data" class="input-icheck"
                                {{ in_array('dashboard.data', $selected_permissions) ? 'checked' : '' }}>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="permissions[]" value="account.access" class="input-icheck"
                                {{ in_array('account.access', $selected_permissions) ? 'checked' : '' }}>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="permissions[]" value="{{ $key }}"
                                class="input-icheck"
                                {{ in_array($key, $selected_permissions) ? 'checked' : '' }}>
                            {{ __($booking) }}
                        </label>
                    </div>
                </div>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="permissions[]" value="access_all_locations"
                                class="input-icheck"
                                {{ in_array('access_all_locations', $selected_permissions) ? 'checked' : '' }}>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="location_permissions[]"
                                ...
                                {{ in_array("location.{$location->id}", $selected_permissions) ? 'checked' : '' }}>
                            {{ $location->name }}
                        </label>
                    </div>
                </div>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="permissions[]" value="access_default_selling_price"
                                class="input-icheck"
                                {{ in_array('access_default_selling_price', $selected_permissions) ? 'checked' : '' }}>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="spg_permissions[]"
                                ...
                                {{ in_array("selling_price_group.{$group->id}", $selected_permissions) ? 'checked' : '' }}>
                            {{ $group->name }}
                        </label>
                    </div>
                </div>
