<div class="modal-dialog" role="document">
  <div class="modal-content">
    <form action="{{ route('invoice-schemes.store') }}" method="POST" id="invoice_scheme_add_form">
      @csrf
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            <div class="form-group">
              ...
              <input type="text" name="name" id="name" class="form-control" required placeholder="@lang('invoice.name')">
            </div>
          </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="input-group col-md-12 col-sm-12">
                  ...
                  <input type="text" name="prefix" id="prefix" class="form-control" placeholder="">
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="input-group col-md-12 col-sm-12">
                  ...
                  <input type="number" name="start_number" id="start_number" class="form-control" value="0" required min="0">
                </div>
              </div>
            </div>
