                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select wire:model.live="category_id" name="category_id" class="form-control "
                                style="width:100%">
                                <option value="">{{ __('lang_v1.all') }}</option>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            ...
                                            <li>
                                                <a href="{{ route('labels.show') }}?product_id={{ $product->id }}"
                                                    data-toggle="tooltip" title="Print Barcode/Label">
                                            ...
                                            <li>
                                                <a href="#"
                                                    data-href="{{ route('opening-stocks.add', $product->id) }}"
                                            ...
                                            <li>
                                                <a
                                                    href="{{ route('products.addSellingPrices', [$product->id]) }}">
                            ...
                            <tr>
                                <td colspan="11">
                                    <div style="display: flex; width: 100%;">
                                        ...
                                        @endcan
                                        &nbsp;
                                        <form action="{{ route('products.massDeactivate') }}" method="POST"
