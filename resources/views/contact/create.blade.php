<div class="modal-dialog modal-lg" role="document" >
  ...
  @endphp
    ...
    <div class="modal-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('name', null, ['class' => 'form-control mousetrap','placeholder' => __('contact.name'), 'required', 'autofocus']); !!}
            </div>
        </div>
      </div>
      ...
      <!--check if customer can gain points-->
      <div class="col-md-4">
        <div class="form-group">
          <div class="checkbox">
            <label>
                 {!! Form::checkbox('points_status', '1', false); !!} {{ __('Allow to gain points') }}
            </label>
