        ...
        @component('components.widget', ['class' => 'box-primary'])
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               id="ref_no" 
                               class="form-control" 
                               value="{{ !empty($purchase->return_parent->ref_no) ? $purchase->return_parent->ref_no : null }}">
                    </div>
                </div>
                <div class="col-sm-12">
                            ...
                            @foreach($purchase->purchase_lines as $purchase_line)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" 
                                               class="unit_price" 
                                               id="unit_price_{{$purchase_line->id}}"
                                               value="{{@num_format($purchase_line->purchase_price_inc_tax)}}">
                                    </td>
                                    <td>
                                        <div class="return_subtotal" id="subtotal_{{$purchase_line->id}}"></div>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="row">
                <div class="col-sm-4">
                    ...
                    @if(!empty($purchase->tax))({{$purchase->tax->name}} - {{$purchase->tax->amount}}%)@endif
                    @php
                        $tax_percent = 0;
