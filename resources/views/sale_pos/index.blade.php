                ...
                <table class="table table-bordered table-striped ajax_view" id="sell_table">
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 footer-total text-center">
                            ...
                            <td><span class="display_currency" id="footer_vat" data-currency_symbol ="true"></span></td><td><span class="display_currency" id="footer_vat_exempt" data-currency_symbol ="true"></span></td>
...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        columns: [
            ...
            { data: 'vatable', name: 'vatable', 'searchable' : false},
            { data: 'vat', name: 'vat', 'searchable' : false},
            { data: 'vat_exempt', name: 'vat_exempt', 'searchable' : false},
            { data: 'vzr', name: 'vzr', 'searchable' : false},
