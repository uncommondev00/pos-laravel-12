					...
					<tbody>
						<tr>
							<td>
								...
								<!-- new for add discount-->
								<div class="col-sm-2 col-xs-6 d-inline-table edit-disc" style="font-size: 20px !important;">

									<span class="">

										<b>@lang('sale.discount')(-):</b>
										<br />
										<i class="fa fa-pencil-square-o cursor-pointer" id="pos-new-edit-discount" title="@lang('sale.edit_discount')" aria-hidden="true" data-toggle="modal" data-target="#posAddDiscountModal"></i>
										<span id="total_discount_val">0</span>
										<input type="hidden" name="discount_type" id="discount_type" value="@if(empty($edit)){{'percentage'}}@else{{$transaction->discount_type}}@endif" data-default="percentage">
						...
						<tr>
							<td>
								<!-- For Draft and Qoutation Button-->
								<div class="col-sm-2 col-xs-6 col-2px-padding hide">
								...
								<div class="col-sm-3 col-xs-6 col-2px-padding">
									<!--Card Button-->
									<button type="button"
										class="btn bg-maroon btn-block btn-flat no-print hide @if(!empty($pos_settings['disable_suspend'])) pos-express-btn btn-lg @endif pos-express-finalize"
								...
								<!--Multiple Pay Button-->
								<div class="col-xs-12 col-2px-padding">
									<button type="button" onclick="myScreen()" class="btn bg-navy  btn-block btn-flat btn-lg no-print @if($pos_settings['disable_pay_checkout'] != 0) hide @endif pos-express-btn" id="pos-finalize" title="@lang('lang_v1.tooltip_checkout_multi_pay')">
										<div class="text-center">
											<i class="fa fa-check" aria-hidden="true"></i>
											<b>@lang('Make Payment')</b>
										</div>
									</button>
									...
									<button type="button"
										...
										title="@lang('lang_v1.tooltip_suspend')" onclick="autoNote();">
										<div class="text-center">
								...
								<!--Cash-->
								<div class="col-sm-3 col-xs-12 col-2px-padding hide">
