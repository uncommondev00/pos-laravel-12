            ...
            <div class="box box-success">
                <div class="box-header with-border col-sm-12">
                    ...
                    <div class="text-right box-tools col-md-1">
                        <a class="btn btn-success btn-sm" onclick="checkCookie2();" href="{{ route('pos.create') }}">
                          <strong><i class="fa fa-plus"></i> POS</strong></a>
                    </div>
                </div>

                <input type="hidden" id="item_addition_method" value="{{ $business_details->item_addition_method }}">
                <form action="{{ route('pos.update', [$transaction->id]) }}" method="post" id="edit_pos_sell_form">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="box-body">
                        <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="exchange_rate" class="form-control input-sm input_number" placeholder="{{ __('lang_v1.currency_exchange_rate') }}" id="exchange_rate" value="{{ @num_format($transaction->exchange_rate) }}">
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" id="hidden_price_group" value="{{ $transaction->selling_price_group_id }}">
                                                <select name="price_group" class="form-control select2" id="price_group" style="width: 100%;">
                                                    @foreach($price_groups as $key => $value)
                                                        <option value="{{ $key }}" @if($transaction->selling_price_group_id == $key) selected @endif>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                                <span class="input-group-addon">
                            ...
                            @if(in_array('subscription', $enabled_modules))
                                <div class="col-md-4 pull-right col-sm-6">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="is_recurring" class="input-icheck" id="is_recurring" value="1" @if($transaction->is_recurring) checked @endif> @lang('lang_v1.subscribe')?
                        ...
                        <div class="row">
                            <div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-6 @endif">
                                <div class="form-group hide">
                                    <div class="input-group">
                                        ...
                                        <select name="contact_id" class="form-control mousetrap" id="customer_id" placeholder="Enter Customer name / phone" readonly required style="width: 100%;">
                                            <option value="">{{ $transaction->contact->name }}</option>
                                        </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <select name="commission_agent" class="form-control select2" placeholder="{{ __('lang_v1.commission_agent') }}">
                            ...
                            <div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-6 @endif">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="search_product" class="form-control mousetrap" id="search_product" placeholder="{{ __('lang_v1.search_product_placeholder') }}" autofocus>
                                        <span class="input-group-btn">
