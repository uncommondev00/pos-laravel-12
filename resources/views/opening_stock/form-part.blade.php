							...
							<tbody>
								...
								<tr>
									<td>
										...
										<input type="hidden" name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][purchase_line_id]" value="{{ $purchase_line_id }}">
										@endif
									</td>
									<td>
										<div class="input-group">
											<input type="text" name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][quantity]" value="{{ @format_quantity($qty) }}" class="form-control input-sm input_number purchase_quantity input_quantity" required>
									...
									<td>
										<input type="text" name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][purchase_price]" value="{{ @num_format($purcahse_price) }}" class="form-control input-sm input_number unit_price" required>
									</td>
									...
									@if($enable_lot == 1)
									<td>
										<input type="text" name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][lot_number]" value="{{ $lot_number }}" class="form-control input-sm">
									</td>
									@endif
									<td>
