...
$(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            if (result.success == true) {
                                ...
                                Livewire.dispatchTo('contacts-table', 'refreshComponent');
                            } else {
                                toastr.error(result.msg);
                            }
                        },
    ...
    $('#view_z_reading').click(function() {
     ...
     //x reading modal
    $('#view_x_reading').click(function() {
        $('#x_reading_modal').modal('show');
    });
    ...
    //Used for Purchase & Sell invoice.
    $(document).on('click', 'a.invoice-print', function(e) {
        e.preventDefault();
        var href = $(this).data('href');
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            if (result.success == true) {
                                ...
                                Livewire.dispatchTo('sales-commision-agent-table', 'refreshComponent');
                            } else {
                                toastr.error(result.msg);
                            }
                        },
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success == true) {
                    ...
                    Livewire.dispatchTo('customer-group-table', 'refreshComponent');
                } else {
                    toastr.error(result.msg);
                }
            },
